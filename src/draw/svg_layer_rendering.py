...
COLOR_ARR_VORT_LOW = ["#e0f3f8", "#abd9e9", "#74add1", "#4575b4"]
...
BOUND_VORT = np.concatenate((
    np.linspace(0.05, 0.15, 5)[:-1],
    np.linspace(0.15, 1.0, len(COLOR_ARR_VORT_HIGH) + 1),
))
